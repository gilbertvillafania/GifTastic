...
$(document).ready(function() {
    ...
    var topics = ["Iron Man", "Captain America", "Thor", "Black Panther", "Avengers", "Ant-Man", "Captain Marvel", "Spider-Man", "Doctor Strange"];	
  ...
  $(document).on('click', '.marvel', function() {
      ...
      var marvelMovies = $(this).html(); 
      // console.log(marvelMovies);
  
      var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + marvelMovies + "&api_key=AqySOs2ILeSqMrGUvhWPa6Rj0DRs6e3N&limit=10";
